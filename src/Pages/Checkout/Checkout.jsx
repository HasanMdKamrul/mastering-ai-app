...
const Checkout = () => {
  ...
  return (
    <div>
      <div className="bg-gray-200 text-black mx-auto rounded-2xl flex justify-center items-center mt-12 shadow-lg container">
        <section className="my-8 ">
          <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
            ...
            <p className="px-6 h-40 py-2 text-2xl font-semibold text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl ">
              <Typewriter
                loop
                words={[
            ...
            <div className="flex justify-center space-x-3 bg-success rounded-2xl py-8 hover:bg-sky-400 px-5">
              <img
                src={image}
                alt=""
              ...
              <div>
                ...
                <Link
                  className="flex items-center py-2 space-x-1 text-sm dark:text-blue-600"
                  to={`/courses/${id}`}
                >
      ...
      <section className="py-20 dark:bg-gray-800  dark:text-gray-100 shadow-2xl">
            ...
            <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
              <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-900">
                ...
                <p className="mt-3 leading-relaxed dark:text-gray-400">
                  Our free offering towords our audience, will come later.
                </p>
