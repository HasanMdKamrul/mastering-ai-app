...
const Instructors = ({ course }) => {
  const { instructor, category } = course;
  const { picture, name } = instructor;
  return (
    <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 border bg-gray-200 dark:bg-gray-100 dark:text-gray-800">
      <img
        alt=""
